...
e=d.f;if(!e.point||e.point.corner!=a.corner){var f=g.Event("start");this.trigger(f,[e.opts,a.corner]);if(f.isDefaultPrevented())return!1}this.removeClass5("flexpaper_page_zoomIn").removeClass5("flexpaper_page_zoomOut").addClass5("flexpaper_page_dragPage");if(c){if(b){var k=this,c=e.point&&e.point.corner==a.corner?e.point:h._c.call(this,a.corner,1);e.userinteracting=!1;this.animatef({from:[c.x,c.y],to:[a.x,a.y],duration:500,frame:function(b){a.x=Math.round(b[0]);a.y=Math.round(b[1]);h._fold.call(k,
